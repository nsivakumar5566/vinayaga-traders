                    ...
                    <div class="card-body">
                        ...
                        <form action="{{ route('orders.store') }}" method="post">
                            ...
                            <div class="multipleQueue">
                                <div class="row g-3">
                                    ...
                                    <div class="col-md-1">
                                        ...
                                        <input type="number" class="variant-qty form-control" id="qty" value="1"
                                            name="qty[]">
                                        @if($errors->has('qty'))
                                        <div class="mt-2" style="color:#620912">
                                            {{ $errors->first('qty') }}
                                    ...
                                    <div class="col-md-3">
                                        ...
                                        <input type="number" class="variant-price form-control" id="price" value=""
                                            readonly name="price[]">
                                        @if($errors->has('price'))
                                        <div class="mt-2" style="color:#620912">
                                            {{ $errors->first('price') }}
                            ...
                            <div class="row g-3 mt-3">
                                ...
                                <div class="col-md-3" id="paid-column" style="display: none;">
